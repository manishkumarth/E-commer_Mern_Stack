...
const {getEmbeddingWithLocal,getEmbeddingWidthApi} = require("../services/Ai")
const searchByImage = async (req, res) => {
  console.log("request",req)
  try {
    console.log("FILE:", req.file);

   const embedding = await getEmbeddingWidthApi(req.file);
...
const generateEmbeddingSingle = async (req, res) => {
  ...
  try {
    ...
    // generate embedding
    let embedding = await getEmbeddingWidthApi(product.image);
